  ...
  return (
    <div>
      ...
      <SnackbarProvider
        ...
        maxSnack={3}
        className="flex bg-red-600 text-base"
        iconVariant={{
          error: <MdErrorOutline className="mr-2 shrink-0 text-xl text-inherit" />,
        }}
      />
        ...
        <div className="flex flex-col sm:flex-row">
          <div className="relative flex flex-col">
            <label htmlFor="email">
              ...
              <input
                className={`${touched.email && errors.email ? 'border-red-600 focus:border-red-700 focus:ring-0' : 'focus:border-transparent focus:outline-none focus:ring-2 focus:ring-primary-600'} w-72 rounded-md px-4 dark:bg-black`}
                type="email"
                id="email"
                name="email"
                value={values.email}
